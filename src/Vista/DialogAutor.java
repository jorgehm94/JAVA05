...
public class DialogAutor extends javax.swing.JDialog {
    ...
    public DialogAutor(java.awt.Frame parent, boolean modal, int cod) {
        super(parent, modal);
        initComponents();
        this.codAutor=cod;
        this.setTitle("Autor "+codAutor);
        gesCon.verDatosAutores(codAutor);
    ...
    {
        Autor registro = gesCon.devolverAutor();
        
        jTextField1.setText(""+registro.getCodAutor());
        jTextField2.setText(""+registro.getNombre());
        jTextField3.setText(""+registro.getPais());
    }
